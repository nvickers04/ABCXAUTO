"""PCS kill scorecard sessions and fill-λ events."""
...
from abcxauto.memory.journal.util import _coerce_order_id, _json_dumps, _row_ts
...
class PcsMixin:
    ...
    def record_pcs_kill_session(
        ...
        *,
        ...
        try:
            ...
            logger.exception(
                "journal.record_pcs_kill_session failed table=pcs_kill_sessions"
            )
            return None
    ...
    def record_pcs_event(self, payload: Any = None, *, ts: Optional[str] = None) -> Optional[int]:
        ...
        try:
            ...
            logger.exception(
                "journal.record_pcs_event failed table=pcs_fill_events order_id=%s",
                oid,
            )
            return None
